...
import 'package:authentication/features/authentication/screens/login.dart';
import 'package:authentication/features/authentication/screens/registration.dart';
    ...
    routes: [
      ...
      GoRoute(
        ...
        builder: (context, state) {
          ...
          return ForgetPasswordPage(type: type ?? forgetPge);
        },
      ),
    ],
  );
