...
class LoginOrSignUpButton extends StatelessWidget {
  const LoginOrSignUpButton({super.key, required this.title, this.onTap});
  final String title;
  final void Function()? onTap;
    ...
    return SizedBox(
      ...
      child: ElevatedButton(
        ...
        child:Text(
              ...
              style: Theme.of(
                context,
              ).textTheme.labelLarge!.copyWith(color: white),
            )
      ),
    );
  }
...
class TermsAndPrivacyButtons extends StatelessWidget {
  const TermsAndPrivacyButtons({super.key});
  ...
  Widget build(BuildContext context) {
    return ElevatedButton.icon(
      ...
      style: Theme.of(context).elevatedButtonTheme.style!.copyWith(
        backgroundColor: WidgetStatePropertyAll(deepWhite),
      ),
      onPressed: () {},
  ...
  Widget build(BuildContext context) {
    return TextFormField(
      ...
      decoration: InputDecoration(
        ...
        enabled: true,
        prefixIcon: Icon(widget.prefixIcon, color: lightGrey),
        suffixIcon:
            widget.showEyeIcon
                ? IconButton(
